...
==========================================================================='
zeon-cli -datadir=$datadir getpeerinfo | jq -r '.[] | select(.inbound==false) | \"\(.addr),\(.pingtime*1000|floor) ,\
...
uptime
echo '==========================================================================='
echo 'Masternode Status: \n# zeon-cli masternode status' && zeon-cli -datadir=$datadir masternode status
echo '==========================================================================='
echo 'Sync Status: \n# zeon-cli mnsync status' &&  zeon-cli -datadir=$datadir mnsync status
echo '==========================================================================='
echo 'Masternode Information: \n# zeon-cli getinfo' && zeon-cli -datadir=$datadir getinfo
echo '==========================================================================='
